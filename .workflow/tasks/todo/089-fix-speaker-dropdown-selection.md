...
- [ ] Selecting a speaker name from the dropdown applies the change immediately
- [ ] The change persists (saved to disk via `UpdateAsync`)
- [ ] Both normal click (global rename) and Shift+click (per-segment) work
- [ ] Manual typing + Enter still works
- [ ] Pressing Escape still cancels the edit
